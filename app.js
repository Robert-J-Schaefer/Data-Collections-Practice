...
let jupiterMoons = solarSystem[4].moons;
console.log(jupiterMoons);

    console.log("--------------------");

    // 2. Print the name of Neptune's moon "Nereid" to the console.
for (let i = 0; i < solarSystem[7].moons.length; i++) {
    if(solarSystem[7].moons[i] === 'Nereid'){
        console.log(solarSystem[7].moons[i]);
    } 
}
...
solarSystem[2].diameter = '1,000 miles';
